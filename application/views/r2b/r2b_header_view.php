<div id="nav_container">
	<div id="navbar_inner" class="navbar-inner">
		<div id="nav_toggler" width="40" height="45" class="pull-left cfm-nav-item"></div>
  		<a id="logo" class="brand cfm-nav-item" href="<?php echo base_url();?>"><img width="180" height="20" src="<?php echo base_url();?>img/r2b_logo.png" /></a>
  		<p style="margin-top:2px; font-size:12px">CREATING COMPELLING CONTENT</p>
